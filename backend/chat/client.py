...
async def _provider_settings_file(
    ...
    if config.max_context_tokens == 0:
        settings["env"]["CLAUDE_CODE_DISABLE_UNKNOWN_MODEL_WINDOW_ENFORCEMENT"] = "1" # https://github.com/farion1231/cc-switch/issues/6221 https://code.claude.com/docs/zh-CN/model-config
